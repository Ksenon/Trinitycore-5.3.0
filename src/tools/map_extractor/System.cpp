...
uint32 const Builds[] = {15595, 16016, 16048, 16057, 16309, 16357, 16516, 16650, 16844, 16965, 16650, 17116, 0};
...
void LoadCommonMPQFiles(uint32 build)
{
    ...
    {
        if (build < NEW_BASE_SET_BUILD && !strcmp("misc.MPQ", CONF_mpq_list[i]))   // 5.3.0
            continue;
