...
handler->PSendSysMessage("Mist-of-Depths.com <http://www.mist-of-depths.com/>");
handler->PSendSysMessage("");
        ...
        handler->PSendSysMessage(" ");
		handler->PSendSysMessage("");
		handler->PSendSysMessage("Administrateur: ");
		handler->PSendSysMessage("");
		handler->PSendSysMessage("Drarkrai, Vashek, ");
        handler->PSendSysMessage("");
		handler->PSendSysMessage("");
		handler->PSendSysMessage("Developpeur:");
		handler->PSendSysMessage("");
		handler->PSendSysMessage("Demontpneu, Loonyx, Oracraft, Darknivor, Hedi, Atomic, Anthony-Arcania");
		handler->PSendSysMessage("");
		handler->PSendSysMessage("");
		handler->PSendSysMessage("Testeurs Moderateurs:");
		handler->PSendSysMessage("");
		handler->PSendSysMessage("Thrylia, DeathKiss, Etxola, Rhyos, SacredCow, Zguegue, Glaedr,");
		handler->PSendSysMessage("");
		handler->PSendSysMessage("");
		handler->PSendSysMessage("Developpeur Web");
		handler->PSendSysMessage("");
		handler->PSendSysMessage("TomyZ,");
		handler->PSendSysMessage("");
