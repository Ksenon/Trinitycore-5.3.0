...
void World::LoadConfigSettings(bool reload)
{
    ...
    SetPlayerAmountLimit(ConfigMgr::GetIntDefault("PlayerLimit", 5000));
    SetMotd(ConfigMgr::GetStringDefault("Motd", "Bienvenue sur Serveur Depths-Core."));
...
void World::SendAutoBroadcast()
{
    ...
    sLog->outDebug(LOG_FILTER_GENERAL, "Informations: '%s'", msg.c_str());
}
